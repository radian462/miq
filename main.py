...
def make(name, id, content, icon):
    ...
    tx.text((1082, 694), BRAND, font=MPLUS_FONT, fill=(120, 120, 120, 255))
...
def whiteMake(name, id, content, icon):
    ...
    tx.text((1082, 694), BRAND, font=MPLUS_FONT, fill=(110, 110, 110, 215))
...
def main():
    ...
    name = f'- {request.args.get("name") or "SAMPLE"}'
