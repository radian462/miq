...
def reverseMake(name, id, content, icon):
    ...
    name_y = tsize_t[2] + 40
    tsize_name = drawText(img, (390, name_y), name, size=28, color=(255, 255, 255, 255), split_len=25, disable_dot_wrap=True)
...
def whiteMake(name, id, content, icon):
    ...
    name_y = tsize_t[2] + 40
    tsize_name = drawText(img, (890, name_y), name, size=28, color=(0, 0, 0, 0), split_len=25, disable_dot_wrap=True)
...
def reverseWhiteMake(name, id, content, icon):
    ...
    name_y = tsize_t[2] + 40
    tsize_name = drawText(img, (390, name_y), name, size=28, color=(0, 0, 0, 0), split_len=25, disable_dot_wrap=True)
